...
var loadDepthName = function(val, depth) {
    ...
    $.ajax({
            ...
            url: "/ajax/basic_mng/common_mng/load_depth_name.php",
...
var loadAfterInfo = function(seq) {
    ...
    $.ajax({
        ...
        url: "/ajax/basic_mng/after_mng/load_after_info.php",
        success: function(result) {
...
var delAfter = function() {
    ...
    $.ajax({
            type: "POST",
            data: {
                "select_prdt" : select_after
            },
            url: "/proc/basic_mng/after_mng/del_after_prdt.php",
            success: function(result) {
            if($.trim(result) == "1") {
...
//후공정 개별 삭제
var delPopAfter = function() {

    $.ajax({
            type: "POST",
            data: {
                "select_prdt" : after_seqno
            },
            url: "/proc/basic_mng/after_mng/del_after_prdt.php",
            success: function(result) {
            if($.trim(result) == "1") {
    ...
    $.ajax({
            ...
            success: function(result) {
	            ...
	            if ($.trim(list[0]) == "") {
                	...
                	$("#after_list").html("<tr><td colspan='10'>검색된 내용이 없습니다.</td></tr>"); 
