...
//상품등록
var insertInfo = function(el, seqno) {
	...
	if (new_tot_tmpt != tot_tmpt) {
        ...
        after_alert[1] = "기준수량이 선택되지 않았습니다.";
        after_alert[2] = "Depth1이 입력되지 않았습니다.";
        after_alert[3] = "Depth2이 입력되지 않았습니다.";
        after_alert[4] = "Depth3이 입력되지 않았습니다.";
	...
	//validation
        ...
        data.crtr_unit = $.trim($("#pop_after_crtr_unit").val());
