...
var getBasicProMngInfo = function() {
    ...
    var url = "/ajax/basic_mng/basic_pro_bus_mng/load_basic_pro_mng_" + el + "_cont.php";
    var data = {
        "el"            : el,
...
var cndSearch = {
    "exec"       : function(el, listSize, page, txt, sorting) {
        ...
        var url = "/ajax/basic_mng/basic_pro_bus_mng/load_basic_pro_mng_list.php";
...
var sortList = function(val, el, selectEl) {
    ...
    cndSearch.exec(selectEl, 30, 1, searchTxt, sorting);
}
...
var selectRadio = {
    "exec"       : function(el, seqno) {
        ...
        var url = "/ajax/basic_mng/basic_pro_bus_mng/load_basic_pro_mng_" + el + "_info.php";
        var data = {
	    "el"     : el,
            "seqno"  : seqno
	};
...
var regiData = function(el) {
    ...
    if (checkBlank(selectTypsetSeqno)) {
	alert("조판이 선택되지 않았습니다.");
        return false;
    }

    var url = "/proc/basic_mng/basic_pro_bus_mng/regi_basic_pro_mng.php";

    if (el === "after" || el === "opt") {
        url = "/proc/basic_mng/basic_pro_bus_mng/regi_basic_pro_" + el + "_mng.php";
    }
...
var delRegiList = function(seqno, el) {
    ...
    var url = "/proc/basic_mng/basic_pro_bus_mng/del_basic_pro_mng.php";
    var data = {
        "el"            : el,
        "seqno"         : seqno
    };
