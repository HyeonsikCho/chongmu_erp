...
//종이명 가져오기
var loadPaperName = function(event, search_str, dvs) {
    ...
    $.ajax({
            ...
            url: "/ajax/basic_mng/paper_mng/load_paper_name.php",
            success: function(result) {
		if (dvs != "select") {

                    searchPopShow(event, 'loadPaperName', 'loadPaperName');
...
var delPaper = function() {
    ...
    $.ajax({
            type: "POST",
            data: {
                "select_prdt" : select_paper
            },
            url: "/proc/basic_mng/paper_mng/del_paper_prdt.php",
            success: function(result) {
            if($.trim(result) == "1") {
...
//종이 개별 삭제
var delPopPaper = function() {

    $.ajax({
            type: "POST",
            data: {
                "select_prdt" : paper_seqno
            },
            url: "/proc/basic_mng/paper_mng/del_paper_prdt.php",
            success: function(result) {
            if($.trim(result) == "1") {
