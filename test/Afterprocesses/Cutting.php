...
html;
    ...
    function JC_makeOrderHtml($param) {
        $html = '<input type="hidden" name="AGroup_1_Sel[]" value="08">';
        $html .= '<input type="hidden" name="AGroup_1[7]" value="08">';
        $html .= '<input type="hidden" name="AGroup_2[7]" value="01">'; // 앞면
        $html .= '<input type="hidden" name="after_price[7]" value="' . $this->costEach() . '">';
