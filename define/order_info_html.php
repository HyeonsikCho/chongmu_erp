...
<br />
<label class=\"control-label cp\">기본가격 %s + 추가후공정 %s + 추가옵션 %s = 상품가격 %s원</label>
<br />
...
<br />
<label class=\"control-label cp\">- 사용가능포인트 %s - 적용가능쿠폰 %s = 최대혜택가 %s원</label>
<br /><br />";
...
<br />
<label class=\"control-label cp\">선입금 %s원, 쿠폰 %s, 포인트 %s, 할인 %s</label>
<br />";
}
?>
