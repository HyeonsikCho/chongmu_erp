...
$rs = $quiescenceListDAO->selectQuiescenceMemberInfo($conn, "SEQ", $param);
$list = makeQuiescenceListHtml($conn, $quiescenceListDAO, $rs, $param);

$count_rs = $quiescenceListDAO->selectQuiescenceMemberInfo($conn, "COUNT", $param);
